       ...
       //     var loadingbarp = GameObject.Find("/UserInterface").transform.Find("MenuContent/Popups/LoadingPopup/ProgressPanel/Parent_Loading_Progress/Loading Elements/LOADING_BAR").gameObject.GetComponent<Image>();
        ...
        //    loadingbarp.transform.localScale = new Vector3(1.25f, 3.66f, 1);
          ...
          //  GameObject.Find("/UserInterface").transform.Find("MenuContent/Popups/LoadingPopup/ProgressPanel/Parent_Loading_Progress/Loading Elements/txt_LOADING_Size").transform.localPosition = new Vector3(201.4574f, 115.55f, 1);
            ...
            GameObject.Find("/UserInterface").transform.Find("MenuContent/Popups/StandardPopup/MidRing").GetComponent<Image>().color = new Color(0.68f, 071, 1, 0.8f);
            GameObject.Find("/UserInterface").transform.Find("MenuContent/Popups/StandardPopup/ProgressLine").GetComponent<Image>().color = new Color(0.68f, 071, 1, 0.8f);
            GameObject.Find("/UserInterface").transform.Find("MenuContent/Popups/StandardPopup/TitleText").GetComponent<Text>().color = new Color(0.68f, 071, 1, 0.8f);
            ...
            GameObject.Find("/UserInterface").transform.Find("MenuContent/Popups/StandardPopup/BodyText").GetComponent<Text>().color = new Color(0.68f, 071, 1, 0.8f);
            GameObject.Find("/UserInterface").transform.Find("MenuContent/Popups/StandardPopup/HighPercent").GetComponent<Text>().color = new Color(0.68f, 071, 1, 0.8f);
            GameObject.Find("/UserInterface").transform.Find("MenuContent/Popups/StandardPopup/LowPercent").GetComponent<Text>().color = new Color(0.68f, 071, 1, 0.8f);
