...
namespace Nocturnal.Ui
{
	internal class BigUIScrollbar
	{
		internal static void Run()
		{
			...
			var scrollbarsocial = CustomScrollbar.Scroll(socialv.gameObject, -78, 0.4f, 1.1f, 0.95f);
			...
			var sld = Apis.Slider.Create(pannelvolumes.gameObject, value => Settings.ConfigVars.clientvolume = value, Settings.ConfigVars.clientvolume, () =>
			{
				...
				Ui.QMBasic.audioSourceNotification.volume = Settings.ConfigVars.clientvolume / 6;
			});
			...
			var buttonclipboard = Apis.BigUI.BigButton.NormalButton("ClipBoard", btn, () =>
				{
