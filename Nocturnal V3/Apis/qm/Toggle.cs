...
namespace Nocturnal.Apis.QM
{
	...
	{
		internal static GameObject Create(string text, GameObject menu, Action vtrue, Action vfalse, bool prevalue = false, bool half = false, float X = 628, float Y = 628)
		{
			...
			var instanciated = GameObject.Instantiate(Objects.togglePrefab, menu.transform).gameObject;
